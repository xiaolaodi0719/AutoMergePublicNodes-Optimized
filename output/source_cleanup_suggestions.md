...
| --- | --- | --- | --- | --- | --- | --- | --- |
| DeltaKronecker-all | 0.134 | 11 | 0.0 | 5853 | 0 | 已测数量 >= 5 且评分偏低 | https://github.com/Delta-Kronecker/V2ray-Config/raw/refs/heads/main/config/all_configs.txt |

## 建议优先保留

| 订阅源 | 评分 | 已测 | 通过率 | 解析数 | 连续死亡 | 原因 | URL |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Au1rxx-base64 | 0.948 | 263 | 0.886 | 1628 | 0 | 源评分较高 | https://raw.githubusercontent.com/Au1rxx/free-vpn-subscriptions/main/output/v2ray-base64.txt |
| Surfboard-tg-mixed | 0.815 | 164 | 0.738 | 7439 | 0 | 源评分较高 | https://raw.githubusercontent.com/Surfboardv2ray/TGParse/main/splitted/mixed |
| ermaozi | 0.75 | 54 | 0.741 | 449 | 0 | 源评分较高 | https://raw.githubusercontent.com/ermaozi/get_subscribe/main/subscribe/v2ray.txt |
...
| mheidari-all | 0.522 | 161 | 0.441 | 19290 | 0 | 证据不足或评分中性 | https://raw.githubusercontent.com/mheidari98/.proxy/main/all |
