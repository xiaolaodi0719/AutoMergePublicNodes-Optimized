...
| --- | --- | --- | --- | --- | --- | --- | --- |
| DeltaKronecker-all | 0.151 | 26 | 0.038 | 7295 | 0 | 已测数量 >= 5 且评分偏低 | https://github.com/Delta-Kronecker/V2ray-Config/raw/refs/heads/main/config/all_configs.txt |

## 建议优先保留

| 订阅源 | 评分 | 已测 | 通过率 | 解析数 | 连续死亡 | 原因 | URL |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Au1rxx-base64 | 0.981 | 372 | 0.909 | 1874 | 0 | 源评分较高 | https://raw.githubusercontent.com/Au1rxx/free-vpn-subscriptions/main/output/v2ray-base64.txt |
| Surfboard-tg-mixed | 0.867 | 209 | 0.789 | 7080 | 0 | 源评分较高 | https://raw.githubusercontent.com/Surfboardv2ray/TGParse/main/splitted/mixed |
...
| mheidari-all | 0.557 | 348 | 0.477 | 16261 | 0 | 证据不足或评分中性 | https://raw.githubusercontent.com/mheidari98/.proxy/main/all |
