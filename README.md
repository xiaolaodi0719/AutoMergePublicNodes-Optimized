...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 76.65 | shadowsocks | 240.3 | mheidari-all |
| 75.79 | vless | 284.9 | Au1rxx-base64 |
| 75.59 | vless | 326.1 | Au1rxx-base64 |
| 75.43 | shadowsocks | 273.0 | Au1rxx-base64 |
| 75.03 | shadowsocks | 246.3 | Surfboard-tg-mixed |

### Top 来源质量

| 来源 | 评分 | 测试数 | 建议 |
| --- | --- | --- | --- |
| Au1rxx-base64 | 0.961 | 267 | prefer |
| Surfboard-tg-mixed | 0.83 | 58 | prefer |
| DeltaKronecker-all | 0.788 | 118 | prefer |
| ermaozi | 0.742 | 31 | prefer |
| mheidari-all | 0.71 | 52 | prefer |
