...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 81.32 | hysteria2 | 258.7 | Au1rxx-base64 |
| 80.92 | shadowsocks | 258.5 | Au1rxx-base64 |
| 80.8 | shadowsocks | 255.0 | Au1rxx-base64 |
| 80.64 | shadowsocks | 270.8 | Au1rxx-base64 |
| 79.71 | trojan | 287.4 | Au1rxx-base64 |

### Top 来源质量

| 来源 | 评分 | 测试数 | 建议 |
| --- | --- | --- | --- |
| mheidari-all | 0.995 | 139 | prefer |
| zhangkai | 0.987 | 59 | prefer |
| Au1rxx-base64 | 0.976 | 448 | prefer |
| Surfboard-tg-mixed | 0.644 | 37 | observe |
| DeltaKronecker-all | 0.537 | 326 | observe |
