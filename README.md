...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 83.02 | http | 206.3 | zhangkai |
| 80.87 | trojan | 192.9 | Au1rxx-base64 |
| 80.36 | vless | 222.7 | Au1rxx-base64 |
| 80.24 | vless | 227.9 | Au1rxx-base64 |
| 80.2 | vless | 229.9 | Au1rxx-base64 |

### Top 来源质量

| 来源 | 评分 | 测试数 | 建议 |
| --- | --- | --- | --- |
| mheidari-all | 1.0 | 38 | prefer |
| Au1rxx-base64 | 0.948 | 325 | prefer |
| zhangkai | 0.929 | 24 | prefer |
| DeltaKronecker-all | 0.778 | 41 | prefer |
| Surfboard-tg-mixed | 0.755 | 161 | prefer |
